...
public class StringUtils {
     ...
     */
    public static boolean greaterThenEqual(String org, String comp) {
        return compare(org, comp) >= 0 ? true : false;
    }
     ...
     */
    public static boolean lessThenEqual(String org, String comp) {
        return compare(org, comp) <= 0 ? true : false;
    }
    ...
    public static String makeQueryString(String urlString, Object o, Class<?> clazz) {
        ...
        // 쿼리 스트링 시작
        queryString.append(hasQueryString ? "&" : "?");

        try {
            for (Field f : clazz.getDeclaredFields()) {
                f.setAccessible(true);
                queryString.append(f.getName())
                        .append("=")
                        .append(URLEncoder.encode(String.valueOf(f.get(o)), Charset.defaultCharset()))
                        .append("&");
            }
