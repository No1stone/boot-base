package io.diddda.lib.common.processor;
...
//                            ClassName.get("ai.mintit.drp.lib.common.util", "ModelMapperUtil"),
                            ClassName.get("io.diddda.lib.common.util", "ModelMapperUtil"),
...
//                                ClassName.get("", simpleName.toString())))
                        .superclass(ParameterizedTypeName.get(ClassName.get("io.diddda.lib.common.converter", "CodeValueConverter"),
                                ClassName.get("", simpleName.toString())))
