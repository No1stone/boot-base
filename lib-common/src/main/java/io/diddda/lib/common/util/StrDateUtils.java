...
public class StrDateUtils {
    ...
    public static String PATTERN_DATETIME_DASH ="yyyy-MM-dd HH:mm:ss";
    ...
    public static String add(TemporalUnit field, long amountToAdd) {
        return format(DateUtils.add(LocalDateTime.now(), field, amountToAdd), PATTERN_DATETIME);
    }
    ...
    public static String add(TemporalUnit field, long amountToAdd, String dateFormat) {
        return format(DateUtils.add(LocalDateTime.now(), field, amountToAdd), dateFormat);
    }
    ...
    public static String add(String dateStr, TemporalUnit field, long amountToAdd, String dateFormat) {
        return format(DateUtils.add(parseDateTime(dateStr), field, amountToAdd), dateFormat);
    }
