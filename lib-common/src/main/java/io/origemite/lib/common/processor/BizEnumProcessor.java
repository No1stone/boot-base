package io.origemite.lib.common.processor;

import io.origemite.lib.common.processor.annotation.BizEnum;
...
//                            ClassName.get("ai.mintit.drp.lib.common.util", "ModelMapperUtil"),
                            ClassName.get("io.origemite.lib.common.util", "ModelMapperUtil"),
...
//                                ClassName.get("", simpleName.toString())))
                        .superclass(ParameterizedTypeName.get(ClassName.get("io.origemite.lib.common.converter", "CodeValueConverter"),
                                ClassName.get("", simpleName.toString())))
