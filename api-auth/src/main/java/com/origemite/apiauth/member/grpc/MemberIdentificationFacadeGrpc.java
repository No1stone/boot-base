...
import com.origemite.apiauth.member.grpc.MemberIdentificationGrpc.MemberIdentificationFindByIdRequest;
import com.origemite.apiauth.member.grpc.MemberIdentificationGrpc.MemberIdentificationItemResponse;
import com.origemite.apiauth.member.grpc.MemberIdentificationGrpc.MemberIdentificationServiceGrpc;
...
public class MemberIdentificationFacadeGrpc extends MemberIdentificationServiceGrpc.MemberIdentificationServiceImplBase {
    ...
    public void findById(MemberIdentificationFindByIdRequest request,
                         io.grpc.stub.StreamObserver<com.origemite.apiauth.member.grpc.MemberIdentificationGrpc.MemberIdentificationItemResponse> responseObserver) {
