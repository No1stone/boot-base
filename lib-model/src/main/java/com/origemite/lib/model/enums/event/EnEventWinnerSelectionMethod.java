package com.origemite.lib.model.enums.event;
...
@BizEnum
public enum EnEventWinnerSelectionMethod implements CodeValue {

    ALL("EWSM000ALL", "(이벤트 응모 대상) 전체"),
    DRAW("EWSM00DRAW", "(이벤트 응모 대상) 추첨")
    ;
    ...
    public static EnEventWinnerSelectionMethod of(String code) {
        return Arrays.stream(EnEventWinnerSelectionMethod.values())
    ...
    public static EnEventWinnerSelectionMethod ofNullable(String code, EnEventWinnerSelectionMethod... allowStatus) {
