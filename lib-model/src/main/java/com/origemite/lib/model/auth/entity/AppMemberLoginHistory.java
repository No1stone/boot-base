...
/**
 * swms_app_member_login_history Entity
 */
@Getter
@Setter
@Builder
...
@AllArgsConstructor
@Entity
@Table(name = "app_member_login_history")
@DynamicInsert
@FieldNameConstants
public class AppMemberLoginHistory extends CreatedEntity {
    ...
    public void update(AppMemberLoginHistory entity) {
