...
@BizEnum
public enum EnEventBenefitType implements CodeValue {

    COUPON("EBT0COUPON", "Coupon")
    ;
    ...
    public static EnEventBenefitType of(String code) {
        return Arrays.stream(EnEventBenefitType.values())
    ...
    public static EnEventBenefitType ofNullable(String code, EnEventBenefitType... allowStatus) {
