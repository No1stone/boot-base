...
@BizEnum
public enum EnFileServerType implements CodeValue {

    S3("COFS0000S3", "S3"),
    FILE("COFS00FILE", "File Server")
    ;
    ...
    public static EnFileServerType of(String code) {
        return Arrays.stream(EnFileServerType.values())
    ...
    public static EnFileServerType ofNullable(String code, EnFileServerType... allowStatus) {
