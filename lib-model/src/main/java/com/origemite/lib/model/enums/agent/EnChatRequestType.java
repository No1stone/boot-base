...
@BizEnum
public enum EnChatRequestType implements CodeValue {

    SPDIS("MARCSPDIS", "코드샵, 상품 상세 이미지 요약")
    ;
    ...
    public static EnChatRequestType of(String code) {
        return Arrays.stream(EnChatRequestType.values())
    ...
    public static EnChatRequestType ofNullable(String code, EnChatRequestType... allowStatus) {
