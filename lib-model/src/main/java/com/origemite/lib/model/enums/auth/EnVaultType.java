package com.origemite.lib.model.enums.auth;
...
@BizEnum
public enum EnVaultType implements CodeValue {
    ...
    public static EnVaultType of(String code) {
        return Arrays.stream(EnVaultType.values())
    ...
    public static EnVaultType ofNullable(String code, EnVaultType... allowStatus) {
