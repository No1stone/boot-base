package com.origemite.lib.model.enums.release;
...
@BizEnum
public enum EnApplicationCode implements CodeValue {

    CSA("APCD000CSA", "codeshop-aos"),
    CSI("APCD000CSI", "codeshop-ios")
    ;
    ...
    public static EnApplicationCode of(String code) {
        return Arrays.stream(EnApplicationCode.values())
    ...
    public static EnApplicationCode ofNullable(String code, EnApplicationCode... allowStatus) {
