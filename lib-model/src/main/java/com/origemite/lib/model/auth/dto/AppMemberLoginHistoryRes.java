...
public class AppMemberLoginHistoryRes {

    @Schema(description = "AppMemberLoginHistoryRes.Id DTO")
    @Data
    ...
    @Schema(description = "AppMemberLoginHistoryRes.Name DTO")
    @Data
    ...
    @Schema(description = "AppMemberLoginHistoryRes.Single DTO")
    @Data
    @EqualsAndHashCode(callSuper = true)
    @FieldDefaults(level = AccessLevel.PRIVATE)
    ...
    @Schema(description = "AppMemberLoginHistoryRes.Item DTO")
    @Data
    @EqualsAndHashCode(callSuper = true)
    @FieldDefaults(level = AccessLevel.PRIVATE)
