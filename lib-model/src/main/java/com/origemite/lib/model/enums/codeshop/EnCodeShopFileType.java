package com.origemite.lib.model.enums.codeshop;
...
@BizEnum
public enum EnCodeShopFileType implements CodeValue {

    // TODO: 항목 채우기
    RESPRESENTATIVE("C1FT000REP", "대표 (Representative) 이미지 파일"),
    DETAIL("C1FTDETAIL", "상품 상세 설명 이미지"),
    ;
    ...
    public static EnCodeShopFileType of(String code) {
        return Arrays.stream(EnCodeShopFileType.values())
    ...
    public static EnCodeShopFileType ofNullable(String code, EnCodeShopFileType... allowStatus) {
