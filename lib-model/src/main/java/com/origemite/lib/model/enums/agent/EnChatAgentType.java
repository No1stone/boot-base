package com.origemite.lib.model.enums.agent;
...
@BizEnum
public enum EnChatAgentType implements CodeValue {

    GPT("MACA00GPT", "ChatGPT"),
    PERPLEXITY("MACAPRPLTY", "Perplexity"),
    GEMINI("MACA00GMN", "Gemini"),
    ;
    ...
    public static EnChatAgentType of(String code) {
        return Arrays.stream(EnChatAgentType.values())
    ...
    public static EnChatAgentType ofNullable(String code, EnChatAgentType... allowStatus) {
