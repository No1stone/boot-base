...
@BizEnum
public enum EnAppInstallationStatus implements CodeValue {
    ...
    public static EnAppInstallationStatus of(String code) {
        return Arrays.stream(EnAppInstallationStatus.values())
    ...
    public static EnAppInstallationStatus ofNullable(String code, EnAppInstallationStatus... allowStatus) {
