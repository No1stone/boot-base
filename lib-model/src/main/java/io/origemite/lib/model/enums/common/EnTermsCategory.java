...
@BizEnum
public enum EnTermsCategory implements CodeValue {

    EVENT("TERM0EVENT", "이벤트")
    ;
    ...
    public static EnTermsCategory of(String code) {
        return Arrays.stream(EnTermsCategory.values())
    ...
    public static EnTermsCategory ofNullable(String code, EnTermsCategory... allowStatus) {
